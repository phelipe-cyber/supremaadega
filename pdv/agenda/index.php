		...
		<script>
			$(document).ready(function() {
				$('#calendar').fullCalendar({
					...
					defaultDate: Date(),
					navLinks: true, // can click day/week names to navigate viewsss
					editable: true,
	...
	<body>
		...
		<div class="container">
			<div class="page-header">
				<h1>Agenda</h1>
				<a  class="collapse-item" href="/Pdv/?viewss=Dashboard1" style=" border-radius: 8px; font-size:18px;">Voltar</a>
