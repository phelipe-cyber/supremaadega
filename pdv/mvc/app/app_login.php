...
?>
<div class="container-fluid text-center" style="width: 100%; height: 100%; padding: 25%; background: black; color: white; ">
	<h1>LOGIN</h1>
	<div>
		...
		<form method="POST" action="session.php">
			<div class="row" style="justify-content: center;">
				...
				<div class="form-group col-md-4">
					...
					<div class="form-group col-md-4 col-form-label" style="align-self: self-end">
					<!-- <label for="recipient-name" class="col-form-label">Senha</label> -->
