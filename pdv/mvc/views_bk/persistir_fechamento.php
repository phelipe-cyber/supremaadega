...
if ($total == 0) {
	...
	echo "<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=/Pdv/?views=Dashboard1'>";
	...
	<h2 class="mb-10 text-center" style="color: black; padding: 20px;">Fechamento de Comanda Efetuado!</h2>
 	...
 	<h4 class="text-center" ><a class="form-group col-md-6 btn btn-success" href="?views=Dashboard1" type="button" style="font-size: 25px;">VOLTAR</a></h4> 
