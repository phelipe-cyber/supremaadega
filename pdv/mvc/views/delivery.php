...
?>
	...
	<h4 style="padding: 3%;" class="mb-12 text-center">


		<form method="POST" action="?view=pedidoBalcao">
			<div class="form-group">

				<input type="hidden" name="mesa" id="mesa" value="delivery">
				<input type="hidden" name="cliente" id="cliente" value="<?php echo $nome; ?>">
				<!-- <input type="hidden" class="btn btn-outline-warning" name="categoria" value="<?php echo $categoria ?>"></input><label type="hidden" style="width: 10px;"></label> -->
				<button type="submit" class="btn btn-outline-success" data-toggle="modal" data-target="">Novo Pedido Delivery</button>
			</div>
		</form>
	</h4>
